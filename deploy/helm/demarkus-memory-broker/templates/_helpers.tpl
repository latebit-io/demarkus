...
*/}}
{{- define "demarkus-memory-broker.name" -}}
...
*/}}
{{- define "demarkus-memory-broker.fullname" -}}
...
{{- define "demarkus-memory-broker.chart" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "demarkus-memory-broker.labels" -}}
helm.sh/chart: {{ include "demarkus-memory-broker.chart" . }}
{{ include "demarkus-memory-broker.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
{{- define "demarkus-memory-broker.selectorLabels" -}}
app.kubernetes.io/name: {{ include "demarkus-memory-broker.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end -}}

{{- define "demarkus-memory-broker.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
{{- default (include "demarkus-memory-broker.fullname" .) .Values.serviceAccount.name -}}
{{- else -}}
...
*/}}
{{- define "demarkus-memory-broker.brokerNamespace" -}}
...
*/}}
{{- define "demarkus-memory-broker.configSecretName" -}}
{{- printf "%s-config" (include "demarkus-memory-broker.fullname" .) -}}
{{- end -}}

{{- define "demarkus-memory-broker.refreshTokensSecretName" -}}
...
*/}}
{{- define "demarkus-memory-broker.writeTokenSecretName" -}}
...
key-name knobs.
*/}}
{{- define "demarkus-memory-broker.mcpTLSMountPath" -}}
/etc/demarkus-memory-broker/tls/mcp
{{- end -}}
...
on bind.
*/}}
{{- define "demarkus-memory-broker.mcpPort" -}}
...
{{- define "demarkus-memory-broker.cookieKeySecretName" -}}
{{- default (printf "%s-cookie-key" (include "demarkus-memory-broker.fullname" .)) .Values.server.cookieKeySecret -}}
{{- end -}}
