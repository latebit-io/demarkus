...
The agent keeps this layout consistent across projects so `/soul`, `/soul-journal`, and the memory skill always know where to look. To tailor the layout, publish `/project-template.md` at the memory root; when present it overrides the skill's built-in layout.
