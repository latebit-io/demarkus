...
Frozen organizational knowledge from `mark://latebit`. This dataset reuses the unchanged v1 private GCS export archive in `tools/benchmarks/artifacts/`; Git holds its v4 manifest, eight scoped tasks, scorer-only rubric, and dataset identity.
...
```bash
make answer-bench
rm -rf tools/benchmarks/corpora/latebit-2026-09-14-v4/restored
tools/bin/demarkus-answer-bench corpus-restore -manifest tools/benchmarks/corpora/latebit-2026-09-14-v4/manifest.json -archive tools/benchmarks/artifacts/latebit-2026-09-14-v1.jsonl.gz -root tools/benchmarks/corpora/latebit-2026-09-14-v4/restored
tools/bin/demarkus-answer-bench inspect -corpus tools/benchmarks/corpora/latebit-2026-09-14-v4/restored -questions tools/benchmarks/corpora/latebit-2026-09-14-v4
```
