...
The canonical layout for this soul. Agents route new knowledge to these documents instead of inventing parallel structures; `/index.md` is the hub and links everything worth finding.
