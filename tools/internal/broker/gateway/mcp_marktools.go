...
func (g *Gateway) toolBodies() (*marktools.Tools, error) {
...
func (g *Gateway) worldSource(worldName, path string) (string, bool) {
...
func (g *Gateway) toolGraph(ctx context.Context) (*marktools.GraphScope, error) {
...
func toolAgent(ctx context.Context) string {
	...
	return core.CanonicalEmail(claims.Email)
}

// run answers a tool call with a shared tool body.
func (g *Gateway) run(call func(*marktools.Tools) marktools.Result) (*mcp.CallToolResult, error) {
	if g.tools == nil {
