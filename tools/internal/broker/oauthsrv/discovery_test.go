...
// per-tick behavior.
func newTestDiscovery(t *testing.T, idp *fakeDiscoveryIdP, ttl time.Duration) (*Discovery, *brokertest.FakeClock) {
	t.Helper()
	clk := brokertest.NewFakeClock(time.Date(2026, 5, 15, 12, 0, 0, 0, time.UTC))
