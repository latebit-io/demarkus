---
name: remember
description: Use when the user wants to remember, save, recall, or query personal notes that should persist across OpenCode sessions. Routes through the demarkus-memory MCP tools against a versioned personal store (local by default, remote when the project is bound) organized by project.
---
