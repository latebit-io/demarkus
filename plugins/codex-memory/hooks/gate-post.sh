#!/usr/bin/env bash
# Codex PostToolUse gate adapter. The shared demarkus-plugin binary decides; on a
# warn (the default strictness) it emits an additionalContext reminder, otherwise
