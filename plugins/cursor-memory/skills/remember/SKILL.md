---
name: remember
description: Use when the user wants to remember, save, recall, or query personal notes that persist across Cursor sessions. Versioned personal soul (local by default, remote when the project is bound), organized by project.
---
