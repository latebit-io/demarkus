...
- **`/knowledge`**: list the systems you've joined and show each one's `root` hub index, so the shared catalog is easy to navigate. The counterpart to `/memory`.
