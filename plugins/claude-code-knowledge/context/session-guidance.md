...
Use the joined system's tools through `mcp__<slug>__mark_*`. MCP tools are named `mcp__<joined-slug>__mark_<operation>`; select the joined slug explicitly.
