---
description: Deprecated alias of /memory-default. Set this project's default demarkus write target: list the joined-memory catalog, pick one, and save it as the binding the destination gate enforces.
---
