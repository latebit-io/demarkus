...
1. **Resolve the project slug.** Read `CLAUDE_PROJECT_DIR` via Bash (`basename "$CLAUDE_PROJECT_DIR"`). Lowercase it and replace spaces with hyphens. If it is unset, ask the user which project.
