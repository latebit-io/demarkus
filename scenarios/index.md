...
- [Five-minute appliance](/install/stack/) — one command: world, broker, library, login, HTTPS
...
A developer runs a personal soul and joins the org system in the same agent —
Claude Code or [pi](https://pi.dev), both plugin pairs sharing one `~/.demarkus`
